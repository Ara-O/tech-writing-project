...
export default function ProjectBox({ project }: props) {
    return (
        <div className="border-solid border w-[550px] box-border px-10 py-9">
            ...
            {project.demoLink && <a href={project.demoLink} target="_blank"> <button className="mt-7 bg-blue-950 text-white hover:bg-transparent border hover:text-white transition-all border-blue-950 hover:border-solid hover:border-white text-sm px-5 py-3">View Demo</button> </a>}
        </div>
    )
}
